...
def result_view(request):
    ...
    for candidate in candidates:
        score, categorie_sentiment = candidate.analyse_sentiment()
        candidate.score_sentiment = score
        candidate.categorie_sentiment = categorie_sentiment
    return render(request, 'voting/voter/result.html', {'candidates': candidates})
